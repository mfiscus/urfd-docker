...
sed -i "s,<?php echo \$Reflector->GetReflectorName(); ?> Multiprotocol Reflector,<a href=\"http://${URL}:${PORT}/\"><img src=\"/img/logo.png\" alt=\"CHRC Logo\" width=\"50\" height=\"50\"></a>,g" ${URFD_WEB_DIR}/index.php # add custom logo
